...
con.query("CREATE TABLE users (id INT AUTO_INCREMENT PRIMARY KEY, username VARCHAR(40) NOT NULL, email VARCHAR(256) NOT NULL, name VARCHAR(40), password VARCHAR(255) NOT NULL, admin TINYINT(1) NOT NULL DEFAULT 0)", function (err, result) {
	if (err) throw err;
